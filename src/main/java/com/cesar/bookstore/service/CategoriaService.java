...
import com.cesar.bookstore.dto.CategoriaDTO;
...
public class CategoriaService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new com.cesar.bookstore.service.exceptions.DataIntegrityViolationException("Categoria não pode ser deletada! Possui livros associados");
		}
